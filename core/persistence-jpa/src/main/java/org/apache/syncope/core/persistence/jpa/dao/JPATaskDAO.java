...
public class JPATaskDAO extends AbstractDAO<Task> implements TaskDAO {
    ...
    private static <T extends Task> Class<? extends AbstractTask> getEntityReference(final Class<T> reference) {
    ...
    private static <T extends Task> String getEntityTableName(final Class<T> reference) {
        return PropagationTask.class.isAssignableFrom(reference)
    ...
    public <T extends Task> List<T> findAll(final Class<T> reference) {
        return findAll(reference, null, null, null, null, -1, -1, List.of());
    }

    private static <T extends Task> StringBuilder buildFindAllQuery(
    ...
    public <T extends Task> void deleteAll(final ExternalResource resource, final Class<T> reference) {
        findAll(reference, resource, null, null, null, -1, -1, List.of()).
